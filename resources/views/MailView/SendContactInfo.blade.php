...
<body style="background: #f8f9fa;padding:1em;">
    ...
    <table border="1" align="center" style="width: 66.66666667%;">
        ...
        <tr>
            <td>Name</td>
            <td>{{$valid_email->name}}</td>
        </tr>
        <tr>
            <td>Email</td>
            <td>{{$valid_email->email}}</td>
        </tr>
        <tr>
            <td>Mobile Number</td>
            <td>{{$valid_email->mobile_no}}</td>
        </tr>
        <tr>
            <td>Location</td>
            <td>{{$valid_email->location}}</td>
        </tr>
        <tr>
            <td>Message</td>
            <td>{{$valid_email->message}}</td>
        </tr>
    </table>
    ...
    <div class="container text-center">
        ...
        <div class="copyrights">
            <p align="center"> &copy; {{$date = date('Y')}} Fun Games Asiaa | All Rights Reserved | Get More Information Click Here <a href="https://fungameasiaa.com/" target="_blank"> Fun Games Asiaa</a></p>
        </div>
    </div>
