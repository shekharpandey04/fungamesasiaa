                            ...
                            <div class="x_content">
                                ...
                                <form action="{{url('AddDistributor')}}" method="post"
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Distributor Id</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input type="number" min="1" id="percentage" autocomplete="off" name="percentage"
                                                value="{{old('percentage')}}" placeholder="Enter percentage"
                                                class="form-control col-md-10" required/>
                                        </div>
                                    </div><div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Pin</label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input type="number" min="1" id="pin" autocomplete="off" name="pin"
