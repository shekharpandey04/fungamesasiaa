                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <div class="col-md-12 col-xs-12">
                                    <a href="{{url('/DistPointreport')}}" title="Add New Player"
                                        class="btn btn-primary">
                                        <i class="fa fa-calendar"></i>
                                        Show All
                                    </a>
                                    <a href="{{url('/SortDistPointHistory/'.'today')}}" title="Add New Player"
                                        class="btn btn-primary">
                                        <i class="fa fa-calendar"></i>
                                        Today
                                    </a>
                                    <a href="{{url('/SortDistPointHistory/'.'yesterday')}}" title="Add New Player"
                                        class="btn btn-info">
                                        <i class="fa fa-calendar"></i>
                                        Yesterday
                                    </a>
                                    <a href="{{url('/SortDistPointHistory/'.'this_week')}}" title="Add New Player"
                                        class="btn btn-success">
                                        <i class="fa fa-calendar"></i>
                                        This Week
                                    </a>
                                    <a href="{{url('/SortDistPointHistory/'.'last_week')}}" title="Add New Player"
                                        class="btn btn-warning">
                                        <i class="fa fa-calendar"></i>
                                        Last Week
                                    </a>
                                    <a href="{{url('/SortDistPointHistory/'.'this_month')}}" title="Add New Player"
                                        class="btn btn-danger">
                                        <i class="fa fa-calendar"></i>
                                        This Month
                                    </a>
                                    <a href="{{url('/SortDistPointHistory/'.'last_month')}}" title="Add New Player"
                                        class="btn btn-dark">
                                        <i class="fa fa-calendar"></i>
                                        Last Month
                                    </a>
                                ...
                                <div class="col-md-6" style="margin-top: 25px;">
                                    ...
                                    <form method="post" action="{{url('/CustomDistPointHistory')}}"
                                    ...
                                    <tr>
                                        <td>
                                            <p data-toggle="modal" data-target="#popup_table" id="show_history"
                                                onclick="show_Dist_history('{{$history_point->distributor_id }}')"
                                                style="color:#ddff21;cursor: pointer;">{{$history_point->distributor_id }}</p>
                                        </td>
...
$(document).ready(function(){
    ...
    <script>
        function show_Dist_history(dist_id){
           // var url = window.location.origin+'/GetHistoryByDistId/'+dist_id;
            var url = "{{url('/')}}"+'/GetHistoryByDistId/'+dist_id;
        $.ajax({
            url: url,
            type: 'get',
            dataType: 'json',
            success:function(response){
                ...
                for(var i=0; i<len; i++){
                    ...
                    var user_id = response['data'][i].distributor_id ;
