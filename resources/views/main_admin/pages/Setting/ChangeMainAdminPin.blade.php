                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="x_panel" style="border:2px solid;">
                            ...
                            <div class="x_content">
                                ...
                                <form action="{{url('MainAdminUpdatePin')}}" method="post"
                                    class="form-horizontal form-label-left">
                                    @csrf
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Main Admin</label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input type="text" id="MainAdmin" style="cursor: not-allowed;" name="MainAdmin"
                                                readonly value="{{Session::get('admin')}}"
                                                class="form-control col-md-10" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Enter Old Pin</label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input type="password" id="old_pin" autocomplete="off" name="old_pin"
                                                placeholder="Enter Old Pin"
                                                class="form-control col-md-10" required/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Enter New Pin</label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input type="password" id="password" autocomplete="off" name="new_pin"
                                                 placeholder="Enter New Pin"
                                                class="form-control col-md-10" required/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Confirm Pin</label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input type="password" id="con_pass" autocomplete="off" name="con_pin"
