                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="x_panel" style="border:2px solid;">
                            ...
                            <div class="x_content">
                                ...
                                <form action="{{url('updateApkVersion')}}" method="post"
                                    class="form-horizontal form-label-left" enctype= 'multipart/form-data'>
                                    @csrf
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Apk Version</label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input type="text" id="apk_version" placeholder="Enter APK Version (ex : 4.2.3)"  name="apk_version"
                                                 value="{{$data->apk_version}}"
                                                class="form-control col-md-10" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Apk File</label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input type="file" id="apk" 
                                                class="form-control col-md-10" name='apk'>
                                        </div>
                                    </div>
