                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form method="post" action="{{url('/UpdateMaxBetLimit')}}"
                                            class="form-horizontal form-label-left" oncopy="return false"
                                            oncut="return false" onpaste="return false">
                                            @csrf
                                        
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Max Limit</label>
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                    <input type="number" min="1" id="limit" name="limit" autocomplete="off"
                                                        placeholder="Enter Maximum Winning Bet Amount" required
