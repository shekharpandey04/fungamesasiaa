                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-xs-12">
                            ...
                            <table id="dtHorizontalExample" class="table  table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    @if($data == 1)
                                    @foreach ($commission as $commission_data)
                                    <tr>
                                        <td>{{$commission_data->distributor_id }}</td>
                                        <td>{{$commission_data->end_date}}</td>
                                        <td>{{$commission_data->start_date}}</td>
                                        <td>{{$commission_data->end_point}}</td>
                                        <td>{{$commission_data->commission}}</td>
                                        <td>{{$commission_data->payable}}</td>
