                ...
                <div class="row">
                    <div class="col-md-6 col-xs-12">
                        <div class="x_panel" style="border:2px solid;">
                            <div class="x_title">
                                <h2>Receive Points From User</h2>
                            ...
                            <div class="x_content">
                                <div class="col-md-12" style="margin-bottom: 15px;">
                                    ...
                                    <a href="{{url('/edit_player/'.$player_data->user_id)}}" title="Update Player" class="btn btn-warning">
                                        <i class="fa-7x fa fa-edit "></i>Update Player
                                    </a>
                                    <a href="{{url('/BlockUser/'.$player_data->user_id)}}" title="Ban Player" class="btn btn-info">
                                        <i class="fa-7x fa fa-ban"></i>Block Player
                                    </a>
                                    <a href="{{url('/ChangePassword/'.$player_data->user_id)}}" title="Change Password" class="btn btn-success">
                                        <i class="fa fa-lock"></i>Change Password
                                    </a>
                                    <a href="{{url('/SendPointToPlayer/'.$player_data->user_id)}}" title="Transfer Point" class="btn btn-danger">
                                        <i class="fa fa-exchange"></i>Transfer Points
                                    </a>
                                    <a href="{{url('/CutPointsOfPlayer/'.$player_data->user_id)}}" title="Transfer Point" class="btn btn-warning">
                                        <i class="fa fa-exchange"></i>Receive Points
                                    </a>
                                </div>
                                <br/>

                                <form method="post" action="{{url('/CutUserPoints')}}" class="form-horizontal form-label-left" oncopy="return false" oncut="return false" onpaste="return false">
                                    @csrf
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Distributor</label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input type="text" id="dist_id" style="cursor: not-allowed;" name="dist_id" readonly value="{{$player_data->distributor_id}}" class="form-control col-md-10" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Enter Id</label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input type="text" id="user_id" style="text-transform:uppercase;" name="user_id" readonly value="{{$player_data->user_id}}" autocomplete="off" placeholder="Enter User Id" class="form-control col-md-10" maxlength="13" required />
                                        </div>
                                    </div>
                                    <div class="form-group">
