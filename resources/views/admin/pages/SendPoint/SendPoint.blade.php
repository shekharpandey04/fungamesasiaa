                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form method="post" action="{{url('/AddUserPoints')}}"
                                    class="form-horizontal form-label-left" oncopy="return false" oncut="return false"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input type="text" id="user_id" style = "text-transform:uppercase;" name="user_id" autocomplete="off"
                                                placeholder="Enter User Id" class="form-control col-md-10" maxlength="13" required />
                                        </div>
                                    </div>
                                    <div class="form-group">
