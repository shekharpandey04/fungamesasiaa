                            ...
                            <ul class="nav side-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="nav child_menu">
                                        <li>
                                            <a href="{{url('/AddNewUser')}}"><i class="fa fa-user-plus"></i>Add New
                                                Player</a>
                                        </li>
                                        <li>
                                            <a href="{{url('/PlayerList')}}"><i class="fa fa-user"></i>Player List</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li>
                                    ...
                                    <ul class="nav child_menu">
                                        <li><a href="{{url('BusinessReport')}}"><i class="fa fa-calendar"></i>Business Report</a></li>
                                        <li><a href="{{url('commission_list')}}"><i class="fa fa-calendar"></i>Commission List</a></li>
                                        <li><a href="{{url('CasionGameReport')}}"><i class="fa fa-calendar"></i>Casino Game Report</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a><i class="fa fa-rupee"></i>Cashier<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{url('/SendPoint')}}"><i class="fa fa-exchange"></i>Send Points to
                                                User</a></li>
                                        <li><a href="{{url('/UserPointreport')}}"><i class="fa fa-calendar"></i>Point
                                                Report</a></li>
                                ...
                                <li>
                                    ...
                                    <ul class="nav child_menu">
                                        <li><a href="{{url('ChangeAdminPassword')}}"><i class="fa fa-lock"></i>Change
                                                Password</a></li>
                                        <li><a href="{{url('ChangePin')}}"><i class="fa fa-key"></i>Change Pin</a></li>
                                        <li><a href="{{url('ReturnPoints')}}"><i class="fa fa-mail-forward"></i>Return
                                                Points</a></li>
                                        <li><a href="{{url('ReturnPointsHistory')}}"><i class="fa fa-calendar"></i>Return Points Histroy</a></li>
                                        <!--<li><a href="{{url('UserReturnPointsHistory')}}"><i class="fa fa-calendar"></i>User Return Points Histroy</a></li>-->
                                    </ul>
                                </li>
                ...
                <div class="nav_menu">
                    <nav>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="#"><img src="{{url('GameImage\coins.svg')}}" width="25px" alt="coins icon">&nbsp;{{Session::get('dist_points')}}</a></li>
                            <li>
