    ...
    <div class="login_wrapper">
        <div class="login_form">
            <section class="login_content">
                <form action="<?php echo e(url('LoginMainAdmin')); ?>" method="post" oncopy="return false" oncut="return false"
                    onpaste="return false">
                    <?php echo csrf_field(); ?>
                    <div class="row login-row">
                        <div class="col-sm-6 col-6 login-msg-col text-center">
                            <img src="<?php echo e(url('GameImage\chip.png')); ?>" class="img-admin">
                            <h1>Admin</h1>
                        ...
                        <div class="col-sm-6 col-6 login-input-col">
                            <div class="flash-message col-sm-7 col-7 ">
                                ...
                                <p class="alert <?php echo e(Session::get('alert-class', 'alert-login')); ?>"
                                    >
...
</html><?php /**PATH /var/www/html/fungames_asiaa/resources/views/main_admin/login.blade.php ENDPATH**/ ?>